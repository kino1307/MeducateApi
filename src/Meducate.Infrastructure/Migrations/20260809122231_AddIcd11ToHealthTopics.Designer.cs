...
namespace Meducate.Infrastructure.Migrations
{
    ...
    [Migration("20260809122231_AddIcd11ToHealthTopics")]
    partial class AddIcd11ToHealthTopics
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Meducate.Domain.Entities.ApiClient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Meducate.Domain.Entities.ApiUsageLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Meducate.Domain.Entities.HealthTopic", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("Icd11Code")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");

                    b.Property<string>("Icd11Title")
                        .HasMaxLength(300)
            ...
            modelBuilder.Entity("Meducate.Domain.Entities.Organisation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Meducate.Domain.Entities.SeenTopic", b =>
                {
                    b.Property<string>("Name")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.ToTable("SeenTopics");
                });

            modelBuilder.Entity("Meducate.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Meducate.Domain.Entities.ApiClient", b =>
                {
                    b.HasOne("Meducate.Domain.Entities.Organisation", "Organisation")
                        .WithMany("ApiClients")
            ...
            modelBuilder.Entity("Meducate.Domain.Entities.ApiUsageLog", b =>
                {
                    b.HasOne("Meducate.Domain.Entities.ApiClient", "Client")
                        .WithMany()
            ...
            modelBuilder.Entity("Meducate.Domain.Entities.Organisation", b =>
                {
                    b.HasOne("Meducate.Domain.Entities.User", "User")
                        .WithOne("Organisation")
                        .HasForeignKey("Meducate.Domain.Entities.Organisation", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
