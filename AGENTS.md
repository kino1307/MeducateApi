...
`Meducate.Tests` — xUnit, no mocking framework, real implementations or hand-rolled fakes. Run with `dotnet test tests/Meducate.Tests`. Covers middleware, helpers, DTOs, entity logic, and the ingestion/refresh/LLM-classification pipeline.
